...
const products: product[] = [
  ...
  new product(
    ...
    500000,
    70000,
    ["assets/img/products/mattress1_1.jpg", "assets/img/products/mattress1_2.jpg"],
    4
  ),
  new product(
    "5",
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div className="card card-lg">
                      <div className="card-body">
                        <ul className="list-styled fs-sm">
                          ...
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-classNameic">
                              classNameic
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-fashion">
                              Fashion
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-boxed">
                              Boxed
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-simple">
                              Simple
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-asymmetric">
                              Asymmetric
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-sidenav">
                              Sidenav
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./index-landing">
                              Landing
                            </a>
                          </li>
                        </ul>
                        ...
                        <div className="row">
                          <div className="col">
                            ...
                            <ul className="list-styled mb-7 fs-sm">
                              ...
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shop-topbar">
                                  Topbar
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shop-collapse">
                                  Collapse
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shop-simple">
                                  Simple
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shop-masonry">
                                  Masonry
                                </a>
                              </li>
                            </ul>
                            ...
                            <ul className="list-styled fs-sm">
                              ...
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./product-images-left">
                                  Images Left
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./product-image-grid">
                                  Image Grid
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./product-image-slider">
                                  Image Slider
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./product-images-stacked">
                                  Images Stacked
                                </a>
                              </li>
                            </ul>
                          ...
                          <div className="col">
                            ...
                            <ul className="list-styled mb-7 fs-sm">
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shopping-cart">
                                  Shopping Cart
                                </a>
                              </li>
                              <li className="list-styled-item">
                              ...
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./order-completed">
                                  Order Completed
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./shipping-and-returns">
                                  Shipping &amp; Returns
                                </a>
                              </li>
                            </ul>
                            ...
                            <ul className="list-styled fs-sm">
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-order">
                                  Order
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-orders">
                                  Orders
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-wishlist">
                                  Wishlist
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-personal-info">
                                  Personal Info
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-address">
                                  Addresses
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-address-edit">
                                  Addresses: New
                                </a>
                              </li>
                            </ul>
                          ...
                          <div className="col">
                            <ul className="list-styled mb-7 fs-sm">
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-payment">
                                  Payment
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-payment-edit">
                                  Payment: New
                                </a>
                              </li>
                              <li className="list-styled-item">
                                <a className="list-styled-link" href="./account-payment-choose">
                                  Payment: Choose
                                </a>
                              </li>
                              <li className="list-styled-item">
                    ...
                    <div className="card card-lg">
                      <div className="card-body">
                        <ul className="list-styled fs-sm">
                          ...
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./contact-us">
                              Contact Us
                            </a>
                          </li>
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./store-locator">
                              Store Locator
                            </a>
                          </li>
                          <li className="list-styled-item">
                          ...
                          <li className="list-styled-item">
                            <a className="list-styled-link" href="./coming-soon">
                              Coming Soon
                            </a>
                          </li>
                          <li className="list-styled-item">
              ...
              <Offcanvas show={showCart} onHide={handleCloseCart} placement="end">
                <Offcanvas.Header closeButton>
                  <Offcanvas.Title>Your Cart ({product.length})</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-8">
                            ...
                            <div className="d-flex align-items-center">
                              <select className="form-select form-select-xxs w-auto" title="select">
                ...
                <div className="offcanvas-body">
                  ...
                  <Link to={`cart`}>
                    <a className="btn w-100 btn-outline-dark mt-2" href="./cart">
                      View Cart
                    </a>
                  </Link>
                </div>
              ...
              <Offcanvas show={showSearch} onHide={handleCloseSearch} placement="end">
                ...
                <Offcanvas.Body>
                    ...
                    <form>
                      ...
                      <div className="input-group input-group-merge">
                        ...
                        <div className="input-group-append">
                          <button className="btn btn-outline-border" type="submit" title="search">
                            <i className="fe fe-search"></i>
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="offcanvas-body border-top fs-sm">
                    ...
                    {products.map((prod) => (
                      <div className="row align-items-center position-relative mb-5" key={prod.id}>
                        <Link to={`/furniture/${prod.id}`}>
                          <div className="col-4 col-md-3" title="image">
                            <img className="img-fluid" src={prod.image[0]} alt="..." />
                          </div>
                          <div className="col position-static">
                            <p className="mb-0 fw-bold">
                              <a className="stretched-link text-body">{prod.name}</a>
                              <br />
